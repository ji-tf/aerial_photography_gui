...
class Ui_AerialPhotographyGUIDialogBase(object):
    def setupUi(self, AerialPhotographyGUIDialogBase):
        ...
        AerialPhotographyGUIDialogBase.resize(1038, 637)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1001, 843))
    ...
    def retranslateUi(self, AerialPhotographyGUIDialogBase):
        ...
        self.button_choise_kml.setText(_translate("AerialPhotographyGUIDialogBase", "..."))
        self.button_choise_txt.setText(_translate("AerialPhotographyGUIDialogBase", "..."))
