...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -3, 1001, 843))
        ...
        self.file_kml_txt = QtWidgets.QLineEdit(self.frame)
        self.file_kml_txt.setObjectName("file_kml_txt")
        self.gridLayout_2.addWidget(self.file_kml_txt, 9, 1, 1, 2)
        self.button_choise_kml = QtWidgets.QToolButton(self.frame)
        self.button_choise_kml.setObjectName("button_choise_kml")
        self.gridLayout_2.addWidget(self.button_choise_kml, 9, 3, 1, 1)
        self.button_choise_txt = QtWidgets.QToolButton(self.frame)
        self.button_choise_txt.setObjectName("button_choise_txt")
        self.gridLayout_2.addWidget(self.button_choise_txt, 2, 3, 1, 1)
        self.file_afs_txt = QtWidgets.QLineEdit(self.frame)
        self.file_afs_txt.setObjectName("file_afs_txt")
        self.gridLayout_2.addWidget(self.file_afs_txt, 2, 1, 1, 2)
        ...
        self.clear.clicked.connect(self.file_afs_txt.clear) # type: ignore
        self.clear.clicked.connect(self.file_kml_txt.clear) # type: ignore
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.clear.setText(_translate("MainWindow", "Очистить поля"))
        self.label_name_object_4.setText(_translate("MainWindow", "Название или шифр объекта съёмки"))
        self.nature_area_4.setItemText(0, _translate("MainWindow", "Застроенная"))
        self.nature_area_4.setItemText(1, _translate("MainWindow", "Не застроенная"))
        self.label_date_start_4.setText(_translate("MainWindow", "Дата начала АФС"))
        self.label_orientation_route_4.setText(_translate("MainWindow", "Ориентация маршрутов (широтная, меридиональная, заданная)"))
        self.label_filming_location_4.setText(_translate("MainWindow", "Съёмочный участок"))
        self.label_overlap_transverse_4.setText(_translate("MainWindow", "Поперечное перекрытие, %"))
        self.executor_4.setItemText(1, _translate("MainWindow", "Котелевский К. А."))
        self.executor_4.setItemText(2, _translate("MainWindow", "Ли В. Ю."))
        self.orientation_route_4.setItemText(1, _translate("MainWindow", "Широтная"))
        self.orientation_route_4.setItemText(2, _translate("MainWindow", "Меридиональная"))
        self.orientation_route_4.setItemText(3, _translate("MainWindow", "Заданная"))
        self.label_customer_4.setText(_translate("MainWindow", "Заказчик"))
        self.label_area_afs_4.setText(_translate("MainWindow", "<html><head/><body><p>Фактическая площадь АФС, км<span style=\" vertical-align:super;\">2</span>, для АФС объекта площадного характера</p></body></html>"))
        self.label_date_end_4.setText(_translate("MainWindow", "Дата окончания АФС"))
        self.label_overlap_longitudinal_4.setText(_translate("MainWindow", "Продольное перекрытие, %"))
        self.label_nature_area_4.setText(_translate("MainWindow", "Характер местности"))
        self.label_type_shoot_4.setText(_translate("MainWindow", "Вид съёмки"))
        self.label_length_afs_4.setText(_translate("MainWindow", "Фактическая протяжность АФС, км, для АФС линейного объекта"))
        self.label_executor_4.setText(_translate("MainWindow", "Исполнитель АФС"))
        self.label_4.setText(_translate("MainWindow", "Выбор камеры"))
        self.radioButton_5.setText(_translate("MainWindow", "Sony RX1RM2"))
        self.radioButton_6.setText(_translate("MainWindow", "Sony A6000"))
        self.label_api_sn_5.setText(_translate("MainWindow", "Серийный номер аэрофотоустановки (гироплатформы)"))
        self.label_camera_sn_5.setText(_translate("MainWindow", "Серийный номер аэрофотокамеры"))
        self.label_focal_len_5.setText(_translate("MainWindow", "Фокусное расстояние аэрофотокамеры, мм"))
        self.label_long_shift_5.setText(_translate("MainWindow", "Наличие и тип компенсации продольного сдвига изображения"))
        self.label_type_lens_5.setText(_translate("MainWindow", "Тип и серийный номер объектива (если объектив заменяемый)"))
        self.focal_len_5.setText(_translate("MainWindow", "20"))
        self.image_format_5.setText(_translate("MainWindow", "ARW"))
        self.label_spectral_characteristics_photo_5.setText(_translate("MainWindow", "Спектральная характеристика аэрофотоснимков"))
        self.type_lens_5.setText(_translate("MainWindow", "Нет"))
        self.frame_size_x_5.setText(_translate("MainWindow", "6000"))
        self.label_camera_model_5.setText(_translate("MainWindow", "Модель аэрофотокамеры"))
        self.frame_size_y_5.setText(_translate("MainWindow", "4000"))
        self.long_shift_5.setText(_translate("MainWindow", "Нет"))
        self.label_api_type_5.setText(_translate("MainWindow", "Тип аэрофотоустановки (гироплатформы)"))
        self.label_resolution_5.setText(_translate("MainWindow", "Номинальное пространственное разрешение, м"))
        self.label_frame_size_y_5.setText(_translate("MainWindow", "Размер кадра N(y) пикс"))
        self.camera_model_5.setText(_translate("MainWindow", "Sony A6000"))
        self.api_type_5.setText(_translate("MainWindow", "Нет"))
        self.label_coordinate_orientation_5.setText(_translate("MainWindow", "Ориентация системы координат снимка"))
        self.label_frame_size_x_5.setText(_translate("MainWindow", "Размер кадра N(x) пикс"))
        self.label_pixel_size_5.setText(_translate("MainWindow", "Физический размер пикселя, мм"))
        self.spectral_characteristics_photo_5.setText(_translate("MainWindow", "NIR"))
        self.label_image_format_5.setText(_translate("MainWindow", "Формат представления цифрового изображения"))
        self.api_sn_5.setText(_translate("MainWindow", "Нет"))
        self.camera_sn_5.setText(_translate("MainWindow", "Нет"))
        self.label_height_5.setText(_translate("MainWindow", "Высота фотографирования, м"))
        self.label_other_equipment_3.setText(_translate("MainWindow", "Прочая аппаратура"))
        self.lidar_type_3.setText(_translate("MainWindow", "Нет"))
        self.label_lidar_sn_3.setText(_translate("MainWindow", "Лидар, серийный номер"))
        self.label_definition_block_3.setText(_translate("MainWindow", "Блок определения положения и ориентации, тип, модель, состав"))
        self.label_receiver_3.setText(_translate("MainWindow", "ГНСС-приёмник, тип, модель"))
        self.receiver_3.setText(_translate("MainWindow", "Topcon OEM"))
        self.label_add_information_4.setText(_translate("MainWindow", "Дополнительные сведения по требованию ТЗ"))
        self.lidar_sn_3.setText(_translate("MainWindow", "Нет"))
        self.aircraft_5.setText(_translate("MainWindow", "Геоскан 201 Агрогеодезия"))
        self.label_lidar_type_3.setText(_translate("MainWindow", "Лидар (тип)"))
        self.other_equipment_3.setText(_translate("MainWindow", "Нет"))
        self.label_aircraft_3.setText(_translate("MainWindow", "Воздушное судно"))
        self.label_afs_txt.setText(_translate("MainWindow", "Список номеров концевых списков маршрутов (файл формата .txt послеполётной обработки АФС)"))
        self.button_choise_kml.setText(_translate("MainWindow", "..."))
        self.button_choise_txt.setText(_translate("MainWindow", "..."))
        self.label_afs_kml.setText(_translate("MainWindow", "Файл KML"))
        self.button_analysis_kml.setText(_translate("MainWindow", "Анализировать файл.kml"))
        self.button_analysis_txt.setText(_translate("MainWindow", "Анализировать файл.txt"))
        self.save.setText(_translate("MainWindow", "Выгрузить форму"))
        self.label_passport_afs.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Паспорт аэрофотосъёмки</span></p></body></html>"))
